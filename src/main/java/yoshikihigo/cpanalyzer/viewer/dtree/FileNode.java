package yoshikihigo.cpanalyzer.viewer.dtree;
...
public final class FileNode extends DefaultMutableTreeNode {
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof FileNode) {
      ...
      if ((thisObject instanceof String) && (targetObject instanceof String)) {

        return thisObject.equals(targetObject);

      } else if ((thisObject instanceof FileInfo) && (targetObject instanceof FileInfo)) {
