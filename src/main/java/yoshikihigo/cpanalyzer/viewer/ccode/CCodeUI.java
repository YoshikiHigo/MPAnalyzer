package yoshikihigo.cpanalyzer.viewer.ccode;
...
class CCodeUI extends BasicTextAreaUI {
  ...
  class SourceCodePlainView extends PlainView {
    ...
    private void drawLineBackground(final Graphics g, final int lineIndex) {
      ...
      try {
        ...
        final Rectangle rectangle = CCodeUI.this.modelToView(this.textArea, startOffset);
  ...
  static public final Color BEFORE_MODIFICATION_LINE_COLOR = new Color(0, 130, 130, 80);
  ...
  CCodeUI(final CODE code, final Set<Integer> emphasizedLines, final JTextArea textArea,
      final Insets margin) {
