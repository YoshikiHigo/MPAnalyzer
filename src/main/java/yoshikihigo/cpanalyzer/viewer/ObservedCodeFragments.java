...
public class ObservedCodeFragments extends Observable {
  ...
  private static final Map<CFLABEL, ObservedCodeFragments> INSTANCES =
      new HashMap<CFLABEL, ObservedCodeFragments>();
  ...
  public boolean addAll(final Collection<Code> codefragments, final Observer source) {
  ...
  public boolean removeAll(final Collection<Code> codefragments, final Observer source) {
  ...
  public boolean setAll(final Collection<Code> codefragments, final Observer source) {
