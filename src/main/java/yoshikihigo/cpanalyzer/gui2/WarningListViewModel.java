...
public class WarningListViewModel extends AbstractTableModel {
  ...
  static final String[] TITLES = new String[] {"ID", "PLACE", "SIZE", "OPERATION", "SUPPORT",
      "FILES", "COMMITS", "AUTHORS", "LASTDATE", "Pattern ID", "MATCHED"};
  ...
  public Object getValueAt(final int row, final int col) {
    ...
    switch (col) {
      ...
      case COL_COMMITS: {
        return warning.pattern.getRevisions()
            .size();
      }
      case COL_AUTHORS: {
      ...
      case COL_MATCHEDCODE: {
        return this.pWarnings.get(warning.pattern)
            .size();
      }
